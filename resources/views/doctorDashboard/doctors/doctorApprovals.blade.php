        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h6 class="page-title mb-0 font-size-18">Pending Doctors</h6>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-centered table-hover align-middle">
                                    ...
                                    <tbody class="font-size-14">
                                        @foreach ($pendingDoctors as $doctor)
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="h-20 w-16">
                                                            @if ($doctor->getFirstMediaUrl('profile_picture'))
                                                                ...
                                                                {{-- @else
                                                                <div class="h-full w-full me-2">
                                                                    <span
                                                                        class="flex items-center justify-center h-full w-full rounded-full bg-soft-primary text-primary font-size-14">
                                                    ...
                                                    <div class="d-flex flex-column gap-2">
                                                                ...
                                                                @if ($doctor->getFirstMediaUrl('identity_document'))
                                                                    <a href="{{ $doctor->getFirstMediaUrl('identity_document') }}"
                                                                        ...
                                                                        <span class="text-body font-size-13">Identity
                                                                            Document</span>
                                                                        <i
                                                                            class="mdi mdi-open-in-new ms-1 font-size-13"></i>
                                                                    </a>
                                                                @else
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                @else
                                                                    <span class="text-muted font-size-13">No License</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <i
                                                                class="mdi mdi-certificate-outline text-muted font-size-18"></i>
                                                            <div class="flex-grow-1">
                                            ...
                                            <!-- Certificates Modal -->
                                            <div id="certificatesModal{{ $doctor->id }}" tabindex="-1"
                                                aria-hidden="true"
