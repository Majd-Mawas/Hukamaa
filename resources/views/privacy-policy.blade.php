    ...
    <div class="container">
        <div class="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to hukamaa, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to hukamaa.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to hukamaa, accessible from <a href="https://hukamaa.com/"
                            rel="external nofollow noopener" target="_blank">https://hukamaa.com/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: contact@hukamaa.com</li>
            </ul>
        </div>
    </div>
</div>
