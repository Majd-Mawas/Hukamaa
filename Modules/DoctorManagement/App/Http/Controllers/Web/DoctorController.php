...
class DoctorController extends Controller
{
    public function index()
    {
        ...
        return view('doctorDashboard.doctors.index', compact('doctors'));
    }

    public function create()
    {
        $specializations = Specialization::all();
        return view('doctorDashboard.doctors.create', compact('specializations'));
    }
    ...
    public function show(DoctorProfile $doctor)
    {
        ...
        return view('doctorDashboard.doctors.show', compact('doctor'));
    }
    ...
    public function edit(DoctorProfile $doctor)
    {
        ...
        return view('doctorDashboard.doctors.edit', compact('doctor', 'specializations'));
    }
        ...
        if ($request->hasFile('certificates')) {
            foreach ($request->file('certificates') as $key => $certificate) {
                $doctor->addMedia($certificate)
                    ->usingName('certificate_' . time() . '_' . $key)
    ...
    public function doctorApprovals()
    {
        ...
        return view('doctorDashboard.doctors.doctorApprovals', compact('pendingDoctors'));
    }
